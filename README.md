...
- Answer: Relational databases are simply databases in a table form while SQL is a query language for relational databases

- [ ] Why do tables need a `primary key`?
- Answer: Table need primary keys because primary keys are the identfiers for a table row

- [ ] What is the name given to a table column that references the primary key on another table.
- Answer: A foreign key column

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
- Answer: We add an intermediary table to smoothen the process
